...
(function() {
	...
	console.log(`live_cdf.PercentileRank(${ w })   =` ,   live_cdf.PercentileRank(w) );
	console.log(`firsts_cdf.PercentileRank(${ w }) =` , firsts_cdf.PercentileRank(w) );
	console.log(`others_cdf.PercentileRank(${ w }) =` , others_cdf.PercentileRank(w) );
